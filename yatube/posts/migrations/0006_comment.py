# Generated by Django 2.2.16 on 2023-01-15 14:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.Post', verbose_name='Пост c комментарием')),
            ],
            options={
                'ordering': ['-created'],
